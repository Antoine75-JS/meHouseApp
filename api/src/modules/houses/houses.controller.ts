...
export class HouseController {
   ...
   * Create a new house
   */
  static async createHouse(req: AuthRequest, res: Response): Promise<void> {
   ...
   * Get user's houses
   */
  static async getUserHouses(req: AuthRequest, res: Response): Promise<void> {
    const userId = req.user!.id;
   ...
   */
  static async getHouseById(req: AuthRequest, res: Response): Promise<void> {
   ...
   */
  static async updateHouse(req: AuthRequest, res: Response): Promise<void> {
    const { id } = houseIdParamSchema.parse(req.params);
   ...
   */
  static async deleteHouse(req: AuthRequest, res: Response): Promise<void> {
    const { id } = houseIdParamSchema.parse(req.params);
   ...
   * Get house members
   */
  static async getHouseMembers(req: AuthRequest, res: Response): Promise<void> {
    const { id } = houseIdParamSchema.parse(req.params);
